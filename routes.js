...
module.exports = function Routes(app, io) {
    ...
    var calendar_ctrl = ctrls.calendar_ctrl(io)
    ...
    app.get('/calendar/:uid', auth, calendar_ctrl.getCalendar)
    app.delete('/calendar/:uid', auth, contacts_ctrl.clear)
